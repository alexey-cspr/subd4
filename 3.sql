...
insert into temp_univer(univer_name) values ('Барановичский государственный университет'),
...
insert into univer(univer_name)
select univer_name from temp_univer
order by univer_name;
